...
Implementation of a book archiver using substrate framework scafolded from [Node Template in Substrate](https://github.com/paritytech/substrate/tree/master/bin/node-template).
...
This Substrate project consists of a number of components that are spread across a few directories.
